  ...
  return (
    ...
    >
      {links.map((link, idx) => {
        ...
        const startPos = getSocketPosition(
          startSocket,
          startNode?.position,
          startNode?.nodeRef.current!.getBoundingClientRect()!,
          scale
        );
        const endPos = getSocketPosition(
          endSocket,
          endNode?.position,
          endNode?.nodeRef.current!.getBoundingClientRect()!,
          scale
        );
